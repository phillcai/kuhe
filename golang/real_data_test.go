...
func generateRealDataTestCase() ([]VehiclePoint, []Vehicle, [][]float64) {
	...
	// 时间矩阵 (分钟) - 简化显示前10x10
	timeMatrix := [][]float64{
		{0.0, 6.7, 6.7, 16.2, 19.0, 17.6, 22.1, 40.8, 5.0, 5.0},
		{7.1, 0.0, 10.0, 19.8, 22.4, 21.1, 25.9, 44.5, 5.0, 5.0},
		{8.1, 11.7, 0.0, 15.7, 17.8, 15.0, 21.6, 39.9, 5.0, 5.0},
		{42.4, 47.2, 39.8, 0.0, 33.8, 33.8, 40.5, 53.6, 5.0, 5.0},
		{44.0, 48.2, 41.0, 35.2, 0.0, 34.6, 41.6, 54.5, 5.0, 5.0},
		{14.2, 17.6, 11.5, 5.0, 5.6, 0.0, 14.6, 26.7, 5.0, 5.0},
		{22.3, 25.5, 17.8, 16.5, 16.6, 13.4, 0.0, 30.6, 5.0, 5.0},
		{36.0, 40.2, 35.3, 27.7, 28.1, 23.8, 29.7, 0.0, 5.0, 5.0},
